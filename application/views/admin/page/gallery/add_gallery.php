...
<div class="card">
	...
	<form class="form-horizontal" method="post" action="<?php echo base_url(); ?>mangement/mangement/insertPackageGallery" enctype="multipart/form-data">
		<div class="card-body">
			<h4 class="card-title">
				<?php
				...
				<div class="col-sm-10">
					<select class="form-control custom-select" name="sub_cat_id" id="sub_cat_id" style="width: 100%; height:36px;" onchange="getCheckSubInSub(this.value);" required="">
                        ...
                        foreach ($subCatList as $value):
                            ?>
						<option value="<?php echo $value->sub_cat_id; ?>">
				...
				<div class="col-sm-10">
					<select class="form-control custom-select" name="sub_in_sub_id" id="sub_in_sub_id" style="width: 100%; height:36px;" required="">
                        ...
                        foreach ($subInSubcategoryList as $value):
                            ?>
						<option value="<?php echo $value->sub_in_sub_id; ?>">
							<?php echo $value->sub_in_sub_cat_name; ?>
						</option>
						<?php
                        endforeach;
                        ?>
