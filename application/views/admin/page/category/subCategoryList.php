		...
		<div class="card">
			<div class="card-body">
				...
				<div class="row">
					...
					<div class="col-md-6">
						<div align="right" style="margin-right: 15px;"><a href="<?php echo base_url(); ?>category/category/sub_create_category"><button type="button" class="btn btn-primary">Add New Category</button></a></div><br>
...
<script>
	...
	function filterSubCategory() {
		...
		$.ajax({
			url: "<?php echo base_url();?>/category/Category/getJsonSubCategory?name=" + value + "&status=" + sts,
			type: "GET",
			dataType: 'json',
			success: function(json) {
				...
				$.map(json, function(item) {
					...
					html += "<td class='text-center'><a class='btn-primary text-center' href='<?php echo base_url(); ?>category/Category/edit_subcategory_frm/" + item.sub_cat_id + "'><div style='color: black;'><i class='zmdi zmdi-edit'> Edit</i></div></a></td>";
					html += "</tr>";
					if ($('#' + id).length < 1) {
