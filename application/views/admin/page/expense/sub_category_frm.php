...
<div class="card">
    ...
    <form class="form-horizontal" method="post" action="<?php echo base_url(); ?>mangement/mangement/ExpenseinsertSubCategory" enctype="multipart/form-data">
        <div class="card-body">
            <h4 class="card-title">
                <?php
            ...
            <div class="border-top">
                <div class="card-body">
                    <div align="right">  
                        ...
                        <a href="<?php echo base_url(); ?>expense/category/getSubCategoryList" style="text-decoration: none;"><button style="margin-top: 10px;" type="button" class="btn btn-danger btn-lg btn-block">Cancel</button></a>
